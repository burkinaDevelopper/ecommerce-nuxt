import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRaw, isRef, isReactive, toRef, defineComponent, provide, createElementBlock, h, computed, unref, shallowReactive, Suspense, nextTick, Fragment, Transition, mergeProps, createApp, effectScope, reactive, getCurrentScope, shallowRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, useSSRContext, onScopeDispose, withCtx, defineAsyncComponent, isReadonly, toRefs, markRaw, Text, isShallow } from 'vue';
...
const _routes = [
  {
    ...
    component: () => import('./cart-XGFXXhzx.mjs').then((m) => m.default || m)
  },
  {
    name: "cart___fr",
    path: "/fr/cart",
  ...
  },
  {
    ...
    component: () => import('./index-DpQrFgJx.mjs').then((m) => m.default || m)
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    ...
    component: () => import('./login-Bw0Iipbp.mjs').then((m) => m.default || m)
  },
  {
    name: "login___fr",
    path: "/fr/connextion",
  ...
  },
  {
    ...
    component: () => import('./_id_-DfyC2amf.mjs').then((m) => m.default || m)
  },
  {
...
const namedMiddleware = {
  auth: () => import('./auth-CSxJ2YCn.mjs'),
  guest: () => import('./guest-CROVB3QH.mjs')
};
...
const layouts = {
  default: () => import('./default-X2IZVJnD.mjs').then((m) => m.default || m),
  main: () => import('./main-CaMRoo19.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CZBxPW7v.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-c-4hmHSt.mjs').then((r) => r.default || r));
...
export { useRoute as a, useRequestEvent as b, encodePath as c, useNuxtApp as d, entry$1 as default, encodeParam as e, useRuntimeConfig as f, defineNuxtRouteMiddleware as g, hasProtocol as h, useCookie as i, joinURL as j, useRouter as k, useSwitchLocalePath as l, parseQuery as m, nuxtLinkDefaults as n, navigateTo as o, parseURL as p, withTrailingSlash as q, resolveRouteObject as r, storeToRefs as s, withoutTrailingSlash as t, useHead as u, defineStore as v, withLeadingSlash as w };
